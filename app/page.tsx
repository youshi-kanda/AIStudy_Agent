      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section>
          {!courses || courses.length === 0 ? (
            <div className="p-4 border border-yellow-500/50 bg-yellow-500/10 rounded-lg text-yellow-200">
              <p>No courses found. Database connection might be incomplete or empty.</p>
            </div>
          ) : (
            <>
